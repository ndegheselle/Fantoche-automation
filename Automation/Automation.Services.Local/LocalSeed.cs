...
/// the <see cref="Scope.Root"/> holding every other element, the built-in
/// <see cref="AutomationControl.StartTask"/>/<see cref="AutomationControl.EndTask"/> elements
/// every graph relies on, and a "Samples" scope with something to look at and to run.
/// </summary>
internal static class LocalSeed
{
    public static void Seed(LocalDbContext db)
    {
        ...
        db.ScopedElements.AddRange(Samples.Build());
